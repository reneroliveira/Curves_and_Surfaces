...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{figure}[!htb]
			\centering
			\label{ex2}
			\includegraphics[scale=0.2]{../images/L1_ex2.png}
		...
		Veja um corte da animação em \href{https://github.com/reneroliveira/Curves_and_Surfaces/tree/main/ggb_files}{ex3.ggb} na Figura \ref{ex3}
		
		\begin{figure}[!htb]
			\centering
			\label{ex3}
			\includegraphics[scale=0.15]{../images/L1_ex3.png}
		...
		Veja um corte da animação do vetor tangente em \href{https://github.com/reneroliveira/Curves_and_Surfaces/tree/main/ggb_files}{ex4.ggb} na Figura \ref{ex4}.
		
		\begin{figure}[!htb]
			\centering
			\label{ex4}
			\includegraphics[scale=0.25]{../images/L1_ex4.png}
		...
		Veja um corte da animação do vetor tangente em \href{https://github.com/reneroliveira/Curves_and_Surfaces/tree/main/ggb_files}{ex9.ggb} na Figura \ref{ex9}.
		
		\begin{figure}[!htb]
			\centering
			\label{ex9}
			\includegraphics[scale=0.2]{../images/L1_ex9.png}
